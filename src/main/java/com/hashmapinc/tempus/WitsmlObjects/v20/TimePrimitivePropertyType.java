...
@XmlType(name = "TimePrimitivePropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
...
public class TimePrimitivePropertyType {
    ...
    @XmlElement(name = "AbstractTimePrimitive")
    protected AbstractTimePrimitiveType abstractTimePrimitive;
     ...
     *     
     */
    public void setAbstractTimePrimitive(AbstractTimePrimitiveType value) {
