 ...
 *       <sequence>
 *         <element name="typeLithology" type="{http://www.witsml.org/schemas/1series}LithologySource"/>
 ...
 *         <element name="tvdBase" type="{http://www.witsml.org/schemas/1series}wellVerticalDepthCoord" minOccurs="0"/>
 ...
 *         <element name="tqAv" type="{http://www.witsml.org/schemas/1series}momentOfForceMeasure" minOccurs="0"/>
 *         <element name="currentAv" type="{http://www.witsml.org/schemas/1series}electricCurrentMeasure" minOccurs="0"/>
 *         <element name="rpmAv" type="{http://www.witsml.org/schemas/1series}anglePerTimeMeasure" minOccurs="0"/>
 *         <element name="wtMudAv" type="{http://www.witsml.org/schemas/1series}densityMeasure" minOccurs="0"/>
 *         <element name="ecdTdAv" type="{http://www.witsml.org/schemas/1series}densityMeasure" minOccurs="0"/>
 *         <element name="dxcAv" type="{http://www.witsml.org/schemas/1series}unitlessQuantity" minOccurs="0"/>
 *         <element name="lithology" type="{http://www.witsml.org/schemas/1series}cs_lithology" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="show" type="{http://www.witsml.org/schemas/1series}cs_show" minOccurs="0"/>
 *         <element name="chromatograph" type="{http://www.witsml.org/schemas/1series}cs_chromatograph" minOccurs="0"/>
 *         <element name="mudGas" type="{http://www.witsml.org/schemas/1series}cs_mudGas" minOccurs="0"/>
 *         <element name="densBulk" type="{http://www.witsml.org/schemas/1series}densityMeasure" minOccurs="0"/>
 *         <element name="densShale" type="{http://www.witsml.org/schemas/1series}densityMeasure" minOccurs="0"/>
 *         <element name="calcite" type="{http://www.witsml.org/schemas/1series}volumePerVolumeMeasure" minOccurs="0"/>
 *         <element name="dolomite" type="{http://www.witsml.org/schemas/1series}volumePerVolumeMeasure" minOccurs="0"/>
 *         <element name="cec" type="{http://www.witsml.org/schemas/1series}equivalentPerMassMeasure" minOccurs="0"/>
 *         <element name="qft" type="{http://www.witsml.org/schemas/1series}illuminanceMeasure" minOccurs="0"/>
 *         <element name="calcStab" type="{http://www.witsml.org/schemas/1series}volumePerVolumeMeasure" minOccurs="0"/>
 *         <element name="nameFormation" type="{http://www.witsml.org/schemas/1series}nameString" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="lithostratigraphic" type="{http://www.witsml.org/schemas/1series}lithostratigraphyStruct" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="chronostratigraphic" type="{http://www.witsml.org/schemas/1series}chronostratigraphyStruct" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="sizeMn" type="{http://www.witsml.org/schemas/1series}lengthMeasure" minOccurs="0"/>
 *         <element name="sizeMx" type="{http://www.witsml.org/schemas/1series}lengthMeasure" minOccurs="0"/>
 *         <element name="lenPlug" type="{http://www.witsml.org/schemas/1series}lengthMeasure" minOccurs="0"/>
 *         <element name="description" type="{http://www.witsml.org/schemas/1series}commentString" minOccurs="0"/>
 *         <element name="cuttingFluid" type="{http://www.witsml.org/schemas/1series}str32" minOccurs="0"/>
 *         <element name="cleaningMethod" type="{http://www.witsml.org/schemas/1series}str32" minOccurs="0"/>
 *         <element name="dryingMethod" type="{http://www.witsml.org/schemas/1series}str32" minOccurs="0"/>
...
public class CsGeologyInterval extends com.hashmapinc.tempus.WitsmlObjects.common.CsGeologyInterval {
    ...
    protected List<LithostratigraphyStruct> lithostratigraphic;
    protected List<ChronostratigraphyStruct> chronostratigraphic;
     ...
     *
     * Objects of the following type(s) are allowed in the list
     * {@link LithostratigraphyStruct }
     * 
     * 
     */
    public List<LithostratigraphyStruct> getLithostratigraphic() {
        if (lithostratigraphic == null) {
            lithostratigraphic = new ArrayList<LithostratigraphyStruct>();
        }
     ...
     *
     * Objects of the following type(s) are allowed in the list
     * {@link ChronostratigraphyStruct }
     * 
     * 
     */
    public List<ChronostratigraphyStruct> getChronostratigraphic() {
        if (chronostratigraphic == null) {
            chronostratigraphic = new ArrayList<ChronostratigraphyStruct>();
        }
