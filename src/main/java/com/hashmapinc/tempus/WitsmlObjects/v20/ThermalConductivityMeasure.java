...
/**
 * <p>Java class for ThermalConductivityMeasure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * <complexType name="ThermalConductivityMeasure">
 *   <simpleContent>
 *     <extension base="<http://www.energistics.org/energyml/data/commonv2>AbstractMeasure">
 *       <attribute name="uom" use="required" type="{http://www.energistics.org/energyml/data/commonv2}ThermalConductivityUom" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * </pre>
...
@XmlType(name = "ThermalConductivityMeasure", propOrder = {
    "value"
})
public class ThermalConductivityMeasure {
