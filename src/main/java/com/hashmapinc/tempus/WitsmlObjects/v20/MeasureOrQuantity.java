 ...
 *       <attribute name="uom" use="required" type="{http://www.energistics.org/energyml/data/commonv2}UomEnum" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * </pre>
...
@XmlType(name = "MeasureOrQuantity", namespace = "http://www.energistics.org/energyml/data/witsmlv2", propOrder = {
    "value"
})
