...
/**
 * <p>Java class for ElectricCurrentMeasure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * <complexType name="ElectricCurrentMeasure">
 *   <simpleContent>
 *     <extension base="<http://www.energistics.org/energyml/data/commonv2>AbstractMeasure">
 *       <attribute name="uom" use="required" type="{http://www.energistics.org/energyml/data/commonv2}ElectricCurrentUom" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * </pre>
...
@XmlType(name = "ElectricCurrentMeasure", propOrder = {
    "value"
})
public class ElectricCurrentMeasure {
