...
/**
 * <p>Java class for IlluminanceMeasure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * <complexType name="IlluminanceMeasure">
 *   <simpleContent>
 *     <extension base="<http://www.energistics.org/energyml/data/commonv2>AbstractMeasure">
 *       <attribute name="uom" use="required" type="{http://www.energistics.org/energyml/data/commonv2}IlluminanceUom" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * </pre>
...
@XmlType(name = "IlluminanceMeasure", propOrder = {
    "value"
})
public class IlluminanceMeasure {
