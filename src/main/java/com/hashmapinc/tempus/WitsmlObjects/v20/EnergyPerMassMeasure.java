...
/**
 * <p>Java class for EnergyPerMassMeasure complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * <complexType name="EnergyPerMassMeasure">
 *   <simpleContent>
 *     <extension base="<http://www.energistics.org/energyml/data/commonv2>AbstractMeasure">
 *       <attribute name="uom" use="required" type="{http://www.energistics.org/energyml/data/commonv2}EnergyPerMassUom" />
 *     </extension>
 *   </simpleContent>
 * </complexType>
 * </pre>
...
@XmlType(name = "EnergyPerMassMeasure", propOrder = {
    "value"
})
public class EnergyPerMassMeasure {
