...
@XmlType(name = "GeneralConversionPropertyType", namespace = "http://www.opengis.net/gml/3.2", propOrder = {
    "abstractGeneralConversion"
})
public class GeneralConversionPropertyType {

    @XmlElement(name = "AbstractGeneralConversion")
    protected AbstractGeneralConversionType abstractGeneralConversion;
     ...
     * @return
     *     possible object is
     *     {@link AbstractGeneralConversionType }
     *     
     */
     ...
     *     
     */
    public void setAbstractGeneralConversion(AbstractGeneralConversionType value) {
