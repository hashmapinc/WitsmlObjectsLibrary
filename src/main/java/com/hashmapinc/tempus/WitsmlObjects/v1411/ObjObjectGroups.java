...
/**
 * <p>Java class for obj_objectGroups complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre> {@code
 * <complexType name="obj_objectGroups">
 *   <complexContent>
 ...
 *         <element name="objectGroup" type="{http://www.witsml.org/schemas/1series}obj_objectGroup" maxOccurs="unbounded"/>
 *       </sequence>
...
@XmlType(name = "obj_objectGroups", propOrder = {
    "documentInfo",
    "objectGroup"
})
public class ObjObjectGroups
    extends AbstractObject
{

    protected CsDocumentInfo documentInfo;
    @XmlElement(required = true)
    protected List<ObjObjectGroup> objectGroup;
     ...
     * 
     */
    public List<ObjObjectGroup> getObjectGroup() {
        if (objectGroup == null) {
            objectGroup = new ArrayList<ObjObjectGroup>();
        }
