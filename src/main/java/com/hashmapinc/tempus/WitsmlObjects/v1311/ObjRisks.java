...
/**
 * <p>Java class for obj_risks complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre> {@code
 * <complexType name="obj_risks">
 *   <complexContent>
 *     <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       <sequence>
 *         <element name="documentInfo" type="{http://www.witsml.org/schemas/131}cs_documentInfo" minOccurs="0"/>
 *         <element name="risk" type="{http://www.witsml.org/schemas/131}obj_risk" maxOccurs="unbounded"/>
 *       </sequence>
...
@XmlType(name = "obj_risks", propOrder = {
    "documentInfo",
    "risk"
})
public class ObjRisks {

    protected CsDocumentInfo documentInfo;
    @XmlElement(required = true)
    protected List<ObjRisk> risk;
     ...
     * 
     */
    public List<ObjRisk> getRisk() {
        if (risk == null) {
            risk = new ArrayList<ObjRisk>();
        }
        return this.risk;
    }
