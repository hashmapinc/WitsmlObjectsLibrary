...
public class CsReferencePoint {
    ...
    //=========================================================================
    public com.hashmapinc.tempus.WitsmlObjects.v1311.CsReferencePoint to1311CsReferencePoint() {
        com.hashmapinc.tempus.WitsmlObjects.v1311.CsReferencePoint point = new com.hashmapinc.tempus.WitsmlObjects.v1311.CsReferencePoint();
        ...
        if (null != this.getElevation())
            point.setElevation(this.getElevation().to1311WellElevationCoord());

        // measuredDepth
        if (null != this.getMeasuredDepth())
            point.setMeasuredDepth(this.getMeasuredDepth().to1311MeasuredDepthCoord());

        // location
        if (null != this.getLocation()) {
            List<com.hashmapinc.tempus.WitsmlObjects.v1311.CsLocation> pointLocationList = new ArrayList<>();
            for (CsLocation location: this.getLocation())
                pointLocationList.add(location.to1311CsLocation());
